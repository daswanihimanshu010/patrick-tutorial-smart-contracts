...
contract SimpleStorage {
    ...
    // view, pure keywords do not require gas to run because we are just asking to view the state
    // not modify

    // view function is just to read state, disallows modification of state/storage/variable in
    // blockchain
    ...
    // calling view functions from inside of gas calling function will then cost gas for view
    // functions also
    ...
    // storage value continue to exist even after after function code execution,
    // the favouriteNumber defined on top is a storage
